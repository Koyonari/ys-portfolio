      ...
      <section ref={sectionRef} className="w-full bg-[#111] text-[#f0ede8] font-sans">
        ...
        <div className="mx-auto max-w-6xl px-8 md:px-16 py-16">
          <div className="grid grid-cols-1 md:grid-cols-[auto_auto_auto_1fr] gap-10 md:gap-16">
            ...
            {/* PAGES */}
            <div className={`w-28 ${fade("delay-[0ms]")}`}>
              <p className="text-xs font-bold uppercase tracking-widest mb-4">Pages</p>
              <nav className="flex flex-col gap-2.5">
                {["Portfolio", "Blog"].map((item) => (
                  <a key={item} href="#" className="text-sm text-[#f0ede8]/55 hover:text-[#f0ede8] transition-colors duration-200 link-hover">
                    {item}
                  </a>
                ))}
              </nav>
            ...
            {/* SOCIAL */}
            <div className={`w-28 ${fade("delay-[80ms]")}`}>
              <p className="text-xs font-bold uppercase tracking-widest mb-4">Social</p>
              <nav className="flex flex-col gap-2.5">
            ...
            <div className={`md:justify-self-end md:max-w-xs ${fade("delay-[240ms]")}`}>
              <p className="text-xs font-bold uppercase tracking-widest mb-4">Background</p>
              <p className="text-sm text-[#f0ede8]/55 leading-relaxed mb-3">BALLS BALLS BALLS</p>
              <p className="text-sm text-[#f0ede8]/55 leading-relaxed mb-6">BALLS BALLS</p>

              {/* SYMBOL */}
              <div className={`flex gap-4 ${fade("delay-[320ms]")}`}>
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="w-7 h-7 flex items-center justify-center text-[#f0ede8]/55 hover:border-[#f0ede8] hover:text-[#f0ede8] transition-colors duration-200">
                  <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                    <title>LinkedIn</title>
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                  </svg>                </a>
                <a href="https://github.com" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="w-7 h-7 flex items-center justify-center text-[#f0ede8]/55 hover:border-[#f0ede8] hover:text-[#f0ede8] transition-colors duration-200">
                  <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                    <title>GitHub</title>
                ...
                <a href="https://monkeytype.com" target="_blank" rel="noopener noreferrer" aria-label="Monkeytype" className="w-7 h-7 flex items-center justify-center text-[#f0ede8]/55 hover:border-[#f0ede8] hover:text-[#f0ede8] transition-colors duration-200">
                  <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
        ...
        <div className="overflow-hidden px-1 mx-auto">
          <div
            className={`font-black uppercase leading-none tracking-tight transition-all duration-[1100ms] ease-out delay-300 text-center ${entered ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"
              }`}
        ...
        <div className="border-t border-[#f0ede8]/10 px-8 md:px-16 py-5">
          <div className="mx-auto max-w-6xl flex flex-wrap items-center justify-between gap-3">
            <span className="text-xs text-[#f0ede8]/40">Last Updated in April 2026</span>
