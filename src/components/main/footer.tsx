          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
            ...
            <div className={`text-xs col-span-2 md:col-span-1 ${fade("delay-[240ms]")}`}>
              ...
              <div className={`flex gap-4 ${fade("delay-[320ms]")}`}>
                ...
                <a href="https://github.com/Koyonari" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="w-5 h-5 lg:w-7 lg:h-7 flex items-center justify-center text-[#f0ede8]/55 hover:text-[#f0ede8] transition-colors duration-200">
                  <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                    <title>GitHub</title>
                ...
                <a href="https://monkeytype.com/profile/ys_monkey" target="_blank" rel="noopener noreferrer" aria-label="Monkeytype" className="w-5 h-5 lg:w-7 lg:h-7 flex items-center justify-center text-[#f0ede8]/55 hover:text-[#f0ede8] transition-colors duration-200">
                  <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
